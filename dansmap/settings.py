"""
Django settings for dansmap project.
...
SECRET_KEY = '$wtf$do8!$+1i47u2%p(=$bwj(2f@)%mb$3t@e@d53r8#iew7g'
...
WSGI_APPLICATION = 'dansmap.wsgi.application'
